...
class HealthDataRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('HealthDataRequest')
    ..e<HealthTypes>(1, 'type', $pb.PbFieldType.OE, HealthTypes.WORKOUT_MAIN, HealthTypes.valueOf,
        HealthTypes.values)
    ..aOS(2, 'startDate')
    ..aOS(3, 'endDate')
    ..a<$core.int>(4, 'limit', $pb.PbFieldType.O3)
    ..e<RequestSorting>(5, 'sorting', $pb.PbFieldType.OE, RequestSorting.DESCENDING_START_DATE,
        RequestSorting.valueOf, RequestSorting.values)
    ..pPS(6, 'units')
    ..hasRequiredFields = false;
...
class HealthDataRequestList extends $pb.GeneratedMessage {
  ...
  HealthDataRequestList copyWith(void Function(HealthDataRequestList) updates) =>
...
class HealthData extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('HealthData')
    ...
    ..aOS(7, 'uuid')
    ..a<SourceRevision>(
        8, 'source', $pb.PbFieldType.OM, SourceRevision.getDefault, SourceRevision.create)
    ..a<EmptySpecificData>(
        10, 'emptyData', $pb.PbFieldType.OM, EmptySpecificData.getDefault, EmptySpecificData.create)
    ..a<QuantitySpecificData>(11, 'quantityData', $pb.PbFieldType.OM,
        QuantitySpecificData.getDefault, QuantitySpecificData.create)
    ..a<CategorySpecificData>(12, 'categoryData', $pb.PbFieldType.OM,
        CategorySpecificData.getDefault, CategorySpecificData.create)
    ..a<WorkoutSpecificData>(13, 'workoutData', $pb.PbFieldType.OM, WorkoutSpecificData.getDefault,
        WorkoutSpecificData.create)
    ..a<CharacteristicSpecificData>(14, 'characteristicData', $pb.PbFieldType.OM,
        CharacteristicSpecificData.getDefault, CharacteristicSpecificData.create)
    ..a<DocumentSpecificData>(16, 'documentData', $pb.PbFieldType.OM,
        DocumentSpecificData.getDefault, DocumentSpecificData.create)
    ..a<CorrelationSpecificData>(17, 'correlationData', $pb.PbFieldType.OM,
        CorrelationSpecificData.getDefault, CorrelationSpecificData.create)
    ..hasRequiredFields = false;
...
class EmptySpecificData extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('EmptySpecificData')..hasRequiredFields = false;
...
class CharacteristicSpecificData extends $pb.GeneratedMessage {
  ...
  CharacteristicSpecificData copyWith(void Function(CharacteristicSpecificData) updates) =>
      super.copyWith((message) => updates(message as CharacteristicSpecificData));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class CorrelationSpecificData extends $pb.GeneratedMessage {
  ...
  CorrelationSpecificData copyWith(void Function(CorrelationSpecificData) updates) =>
...
class StatisticsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('StatisticsRequest')
    ...
    ..aOS(2, 'startDate')
    ..aOS(3, 'endDate')
    ..pc<StatisticsOptions>(
        4, 'options', $pb.PbFieldType.PE, null, StatisticsOptions.valueOf, StatisticsOptions.values)
    ..hasRequiredFields = false;
...
class StatisticsData_StatisticsDataBySource extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('StatisticsData.StatisticsDataBySource')
    ..a<SourceRevision>(
        1, 'source', $pb.PbFieldType.OM, SourceRevision.getDefault, SourceRevision.create)
    ..a<StatisticsData>(
        2, 'data', $pb.PbFieldType.OM, StatisticsData.getDefault, StatisticsData.create)
    ..hasRequiredFields = false;

  StatisticsData_StatisticsDataBySource._() : super();
  factory StatisticsData_StatisticsDataBySource() => create();
  factory StatisticsData_StatisticsDataBySource.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  ...
  StatisticsData_StatisticsDataBySource copyWith(
      ...
      super.copyWith((message) => updates(message as StatisticsData_StatisticsDataBySource));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class StatisticsData_TimeInterval extends $pb.GeneratedMessage {
  ...
  StatisticsData_TimeInterval copyWith(void Function(StatisticsData_TimeInterval) updates) =>
      super.copyWith((message) => updates(message as StatisticsData_TimeInterval));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class StatisticsData extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('StatisticsData')
    ...
    ..a<QuantitySpecificData>(4, 'minimumQuantity', $pb.PbFieldType.OM,
        QuantitySpecificData.getDefault, QuantitySpecificData.create)
    ..a<QuantitySpecificData>(5, 'sumQuantity', $pb.PbFieldType.OM, QuantitySpecificData.getDefault,
        QuantitySpecificData.create)
    ..a<QuantitySpecificData>(6, 'duration', $pb.PbFieldType.OM, QuantitySpecificData.getDefault,
        QuantitySpecificData.create)
    ..a<QuantitySpecificData>(7, 'mostRecentQuantity', $pb.PbFieldType.OM,
        QuantitySpecificData.getDefault, QuantitySpecificData.create)
    ..a<StatisticsData_TimeInterval>(8, 'mostRecentQuantityDateInterval', $pb.PbFieldType.OM,
        StatisticsData_TimeInterval.getDefault, StatisticsData_TimeInterval.create)
    ..a<StatisticsData_TimeInterval>(9, 'dataInterval', $pb.PbFieldType.OM,
        StatisticsData_TimeInterval.getDefault, StatisticsData_TimeInterval.create)
    ..pc<StatisticsData_StatisticsDataBySource>(
        10, 'dataBySource', $pb.PbFieldType.PM, StatisticsData_StatisticsDataBySource.create)
    ..hasRequiredFields = false;
